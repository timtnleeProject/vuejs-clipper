        ...
        <div class="settings">
          ...
          <div class="flex">
            <div class="flex">
              ...
              <span>
                <input v-model.number="outline" type="number" min="1">
              </span>
            </div>
            <div class="flex">
              <span class="label">border</span>
              <span>
                <input v-model.number="border" type="number" min="1">
              </span>
            </div>
          </div>
          <div class="flex">
            <span class="label">minWidth(%)</span>
            <span>
              <input v-model.number="minWidth" type="number" min="1" max="50">
            </span>
            <span class="label">minHeight(%)</span>
            <span>
              <input v-model.number="minHeight" type="number" min="1" max="50">
            </span>
          </div>
          <div class="flex">
          ...
          <div class="flex">
            ...
            <span>
              <input type="checkbox" name="grid" v-model="grid">grid
            </span>
          </div>
          <div class="flex">
            <span class="label">ratio:</span>
            <span>
              <input type="radio" name="ratio" :value="0" v-model.number="ratio">no ratio
            </span>
            <span>
              <input type="radio" name="ratio" :value="1" v-model.number="ratio">1:1
            </span>
            <span>
          ...
          <div class="flex">
            ...
            <span>
              <input type="radio" name="mode" value="normal" v-model="mode">normal
            </span>
            <span>
              <input type="radio" name="mode" value="switch" v-model="mode">switch
            </span>
          </div>
          <div class="flex">
            <span class="label">bgColor:</span>
            <span>
              <input type="radio" name="bgColor" value="#000000" v-model="bgColor">
              <span class="color-tick" style="background-color:#000000"></span>
            </span>
            <span>
              <input type="radio" name="bgColor" value="#d8adad" v-model="bgColor">
              <span class="color-tick" style="background-color:#d8adad"></span>
            </span>
            <span>
              <input type="radio" name="bgColor" value="#a1cfea" v-model="bgColor">
              <span class="color-tick" style="background-color:#a1cfea"></span>
            </span>
            <span>
              <input type="radio" name="bgColor" value="#bc1229" v-model="bgColor">
              <span class="color-tick" style="background-color:#bc1229"></span>
            </span>
          </div>
          <div class="flex">
            <span class="label">shadow:</span>
            <span>
              <input type="radio" name="shadow" value="rgba(0,0,0,0.4)" v-model="shadow">
              <span class="shadow-tick" style="background-color:rgba(0,0,0,0.4)"></span>
            </span>
            <span>
              <input type="radio" name="shadow" value="rgba(0,0,0,0.8)" v-model="shadow">
              <span class="shadow-tick" style="background-color:rgba(0,0,0,0.8)"></span>
            </span>
            <span>
              <input type="radio" name="shadow" value="rgba(255,255,255,0.2)" v-model="shadow">
              <span class="shadow-tick" style="background-color:rgba(255,255,255,0.2)"></span>
            </span>
            <span>
              <input type="radio" name="shadow" value="rgb(27, 170, 232,0.5)" v-model="shadow">
              <span class="shadow-tick" style="background-color:rgb(27, 170, 232,0.5)"></span>
            </span>
          </div>
          <div class="flex">
