<template>
    <div class="list-content content">
        <div class="area">
            ...
            <p>Clipper-basic, which acts like a <i>img</i> element, will automatically set its height <b>based on width</b>. </p>
            <p>Clipper-basic will set it’s layout ratio same as image.</p>
            <p>Clipper-fixed will set it’s layout ratio same as its “ratio” attribute.</p>
            <p>For example you set both clipper-basic and clipper-fixed to have max-width 500 pixels, 
            upload a image which width and height are <u>4:3</u>, then clipper-basic will be <u>500 x 375</u>.</p>
            <p>Assume clipper-fixed has attribute ratio set to 1, then clipper-fixed will be <u>500 x 500</u>.</p>
            <p>This might not be an good idea for clipper-basic when uploading a verticle image, if you upload an image which is 1:2, 
            clipper-basic will become <u>500 x 1000</u> that might ruin the layout of the page.
            </p>
            <h3>upload image</h3>
            <img class="pic" src="long.jpg">
            <h3>Clipper-fixed</h3>
            <p>Clipper-fixed will set it’s layout ratio same as its “ratio” attribute (default 1).</p>
